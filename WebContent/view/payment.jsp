...
<html>
	...
	<body >
        ...
        <form action="payment" method="get" style="display: flex; flex: 1; flex-direction: column; background-color: white; margin: 0.5%; border-radius: 4px; height: 98%; overflow-x: hidden; overflow-y: auto;">
					<div style="display: flex; flex: 6; flex-direction: column; align-items: center;">
						<img src="http://www.merndaps.vic.edu.au/wp-content/uploads/2016/09/credit-card.png" style="max-width: 160px; max-height: 160px; border-radius: 8px;"/>
						<p>Payment Confirmation</p>
						<p>Amount: $${amount}</p>
						<p>Card Number:</p>
						<input name="card number" placeholder="Card Number"/>
						<p>Name on Card:</p>
						<input name="card name" placeholder="Card Name"/>
						<p>Expiry Date:</p>
						<input name="card expiry" placeholder="Card Expiry Date" type="date"/>
						<p>CVV:</p>
						<input name="card cvv" type="password"/>
					</div>
					<div style="display: flex; flex: 1; align-items: center; justify-content: center;">
						<button type="submit" name="command" value="payment post" style="color: white; background-color: black; border: none; border-radius: 8px; padding: 2%; height: 80%; width: 50%; margin: 0.5%;">Confirm</button>
					</div>
        </form>
