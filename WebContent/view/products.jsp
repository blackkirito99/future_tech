            ...
            <div style="display: flex; flex: 1; flex-direction: column; margin: 0 0.5% 0.5% 0.5%; overflow-x: hidden; overflow-y: auto;">
              ...
              <%
				...
				<c:forEach items="${products}" var="product">
					<form method="get" class="product card" style="text-align: center; background-color: gainsboro; border-radius: 8px; padding: 8px; margin: 8px; width: 22%; display: inline-block; vertical-align: top;">
