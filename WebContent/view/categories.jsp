            ...
            <div style="display: flex; flex: 1; flex-direction: column; margin: 0 0.5% 0.5% 0.5%; overflow-x: hidden; overflow-y: auto;">
              <div>
	              <c:forEach items="${categories}" var="category">
						<form action="category" method="get" class="category card" style="text-align: center; background-color: gainsboro; border-radius: 8px; padding: 8px; margin: 8px; width: 20%; display: inline-block;">
							<input type="hidden" name="category" value="${category}"/>
							<button type="submit" name="command" value="category get" style="border: none; border-radius: 8px; padding: 4px; width: 100%;">
