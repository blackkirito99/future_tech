...
%>
<%@ page
	import="java.io.*, java.util.*, domain.Product, auth.AppUtils"
	language="java"
	...
	<body >
        ...
        <div style="display: flex; flex: 2; flex-direction: column; background-color: white; margin: 0.5%; border-radius: 1%; height: 98%;">
	          ...
	          <p>Store details</p>
					...
					<form action="new" method="get" style="display: flex; flex: 1; flex-direction: column; background-color: white; margin: 0 0.5% 0.5% 0.5%; border-radius: 4px; width: 98%; align-items: center; justify-content: center;">
						<% if(AppUtils.isValidRetailer()){ %>
							<button type="submit" name="command" value="product patch" style="color: white; background-color: black; border: none; border-radius: 8px; padding: 2%; height: 80%; width: 98%;">Add new product</button>
						<% } %>
					</form>
        </div>
